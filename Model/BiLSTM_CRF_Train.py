...
def test_model(model, data_op, trainset):
    ...
    if data_op == "msra":
        ...
        test_dataset, _, _, _ = load_data("../PickleFiles/English_Twitter_NER_Corpus_test.pkl", batch_size=512)
...
if __name__ == "__main__":
    ...
    twitter_train, vocab_size_t, tag_size_t, _ = load_data("../PickleFiles/English_Twitter_NER_Corpus_train.pkl", batch_size=512)
